...
module.exports = function (config) {
  const options = {
    ...
    files: [
      ...
      { pattern: "cesium/Build/CesiumUnminified/Cesium.js", included: true },
      {
        pattern: "cesium/Build/CesiumUnminified/Cesium.js.map",
        included: false,
      },
      { pattern: "cesium/Build/CesiumUnminified/**", included: false },
    ...
    proxies: {
      ...
      "/cesium/Data": "/base/cesium/Specs/Data",
    },
