...
var IonSdkSensors=(()=>{var Xt=Object.create;var Xi=Object.defineProperty;var er=Object.getOwnPropertyDescriptor;var nr=Object.getOwnPropertyNames;var ir=Object.getPrototypeOf,or=Object.prototype.hasOwnProperty;var tr=(e,i)=>()=>(i||e((i={exports:{}}).exports,i),i.exports),rr=(e,i)=>{for(var t in i)Xi(e,t,{get:i[t],enumerable:!0})},Vt=(e,i,t,s)=>{if(i&&typeof i=="object"||typeof i=="function")for(let a of nr(i))!or.call(e,a)&&a!==t&&Xi(e,a,{get:()=>i[a],enumerable:!(s=er(i,a))||s.enumerable});return e};var Ie=(e,i,t)=>(t=e!=null?Xt(ir(e)):{},Vt(i||!e||!e.__esModule?Xi(t,"default",{value:e,enumerable:!0}):t,e)),ar=e=>Vt(Xi({},"__esModule",{value:!0}),e);var we=tr((us,zt)=>{zt.exports=Cesium});var cs={};rr(cs,{ConicSensor:()=>Io,ConicSensorGraphics:()=>zi,ConicSensorVisualizer:()=>Po,CustomPatternSensor:()=>sn,CustomPatternSensorGraphics:()=>Ti,CustomPatternSensorVisualizer:()=>Ho,RectangularSensor:()=>xo,RectangularSensorGraphics:()=>Vi,RectangularSensorVisualizer:()=>Do,SensorVolume:()=>w,SphericalPolygon:()=>oo,SphericalPolygonShaderSupport:()=>Fi,_shadersConicSensorInsideFS:()=>un,_shadersConicSensorOutsideFS:()=>mn,_shadersEllipsoidHorizonFacetFS:()=>zn,_shadersEllipsoidHorizonFacetInsideFS:()=>si,_shadersEllipsoidHorizonFacetOutsideFS:()=>li,_shadersInfiniteCone:()=>xe,_shadersPlanarSensorVolumeFS:()=>Tn,_shadersPlanarSensorVolumeVS:()=>Pn,_shadersSensorDomeFS:()=>Hn,_shadersSensorDomeInsideFS:()=>ci,_shadersSensorDomeOutsideFS:()=>di,_shadersSensorSurfaceFS:()=>to,_shadersSensorVolume:()=>le,_shadersSensorVolume2DFS:()=>ui,_shadersSensorVolume2DVS:()=>mi,_shadersSensorVolume3DVS:()=>Re,_shadersSensorVolumeDepth:()=>Ee,_shadersisZeroMatrix:()=>G,initializeSensors:()=>Ao,processCommonSensorProperties:()=>Mn,processConicSensor:()=>$i,processCustomPatternSensor:()=>Ji,processRectangularSensor:()=>Qi});var D=Ie(we(),1),sr=7;function on(e){this._isConvex=void 0,this._vertices=[],this._directions=[],this._referenceAxis=void 0,this._referenceDistance=void 0,this._normalsAndBisectorsWithMagnitudeSquared=void 0,(0,D.defined)(e)&&(this.vertices=e),this._convexHull=[]}var No=new D.Cartesian3,Ro=new D.Cartesian3,Hi=new D.Cartesian3;function eo(e,i,t,s){return No=D.Cartesian3.subtract(e,i,No),Ro=D.Cartesian3.subtract(t,i,Ro),s=D.Cartesian3.normalize(D.Cartesian3.cross(Ro,No,s),s),Hi=D.Cartesian3.divideByScalar(D.Cartesian3.add(D.Cartesian3.add(e,i,Hi),t,Hi),3,Hi),D.Cartesian3.dot(Hi,s)}function io(e,i,t){t=D.Cartesian3.divideByScalar(D.Cartesian3.add(e,i,t),2,t);let s=D.Cartesian3.magnitude(t);return t=D.Cartesian3.normalize(t,t),s}var ko=new D.Cartesian3,Wo=new D.Cartesian3,xi=new D.Cartesian3;function lr(e,i,t,s){let a=io(e,i,ko),l=io(i,t,Wo),m=io(t,e,xi);return a<=l?a<=m?D.Cartesian3.dot(t,ko)>=a?(s=D.Cartesian3.clone(ko,s),a):eo(e,i,t,s):D.Cartesian3.dot(i,xi)>=m?(s=D.Cartesian3.clone(xi,s),m):eo(e,i,t,s):l<=m?D.Cartesian3.dot(e,Wo)>=l?(s=D.Cartesian3.clone(Wo,s),l):eo(e,i,t,s):D.Cartesian3.dot(i,xi)>=m?(s=D.Cartesian3.clone(xi,s),m):eo(e,i,t,s)}var Un=new D.Cartesian3,Lo=new D.Cartesian3,Bo=new D.Cartesian3;on.findConvexHull=function(e,i,t,s,a){let l=e.length;if(a.length=0,t<s)for(let r=t;r<=s;++r)a.push(r);else{for(let r=t;r<l;++r)a.push(r);for(let r=0;r<=s;++r)a.push(r)}let m=a.length,d;do{d=a.length;let r=d-1,f=0,c=1;do{let h=e[a[r%a.length]],_=e[a[f%a.length]],C=e[a[c%a.length]];Un=D.Cartesian3.cross(_,h,Un),Lo=D.Cartesian3.cross(C,_,Lo),i*D.Cartesian3.dot(D.Cartesian3.cross(Un,Lo,Bo),_)>=0?(r=f,f=f+1,c=f+1):a.splice(f,1)}while(f!==a.length)}while(a.length!==d);if(a.length<3)a.length=0;else if(a.length!==m){let r;a.holes=[];for(let h=0;h<a.length-1;++h){let _=a[h],C=a[h+1];(_<C?C-_:C+l-_)>1&&(r=[],on.findConvexHull(e,i*-1,_,C,r),r.length!==0&&a.holes.push(r))}let f=a[0],c=a[a.length-1];c===s&&f!==t?(r=[],on.findConvexHull(e,i*-1,s,f,r),r.length!==0&&a.holes.push(r)):c!==s&&f===t?(r=[],on.findConvexHull(e,i*-1,c,t,r),r.length!==0&&a.holes.push(r)):c!==s&&f!==t&&(r=[],on.findConvexHull(e,i*-1,c,f,r),r.length!==0&&a.holes.push(r))}};var Di=new D.Cartesian3;on.prototype.computeBoundingCone=function(e){let i=e.length;for(let t=0;t<i;++t){let s=this._directions[e[t]];for(let a=t+1;a<i;++a){let l=this._directions[e[a]];for(let m=a+1;m<i;++m){let d=this._directions[e[m]],r=lr(s,l,d,Di),f;for(f=0;f<i;++f)if(f!==t&&f!==a&&f!==m){let c=this._directions[e[f]];if(D.Cartesian3.dot(c,Di)<r)break}f===i&&(this._referenceAxis=D.Cartesian3.clone(Di,this._referenceAxis),this._referenceDistance=r)}}}};on.prototype.computeBoundingCone2=function(){let e=this.convexHull,i=e.length,t=-1,s=-1,a=1;for(let m=0;m<i;++m){let d=this._directions[e[m]];for(let r=m+1;r<i;++r){let f=this._directions[e[r]],c=io(d,f,Di);c<a&&(t=m,s=r,this._referenceAxis=D.Cartesian3.clone(Di,this._referenceAxis),this._referenceDistance=c,a=c)}}let l=[];for(let m=0;m<i;++m)if(m===t||m===s)l.push(e[m]);else{let d=e[m],r=this._directions[d];D.Cartesian3.dot(r,this._referenceAxis)<this._referenceDistance&&l.push(d)}l.length>2&&this.computeBoundingCone(l)};var Bn=new D.Cartesian3,dn=new D.Cartesian3,Fo=new D.Cartesian3,no=new D.Cartesian3,qn=new D.Cartesian3;Object.defineProperties(on.prototype,{isConvex:{get:function(){return this._isConvex}},vertices:{get:function(){return this._vertices},set:function(e){if((0,D.defined)(e)){let i=e.length,t=i*2;this._normalsAndBisectorsWithMagnitudeSquared=new Float32Array(3*t+i),this._isConvex=!0,no=D.Cartesian3.fromSpherical(e[i-1],no),qn=D.Cartesian3.clone(no,qn);for(let s=0;s<i;++s){let a=D.Cartesian3.fromSpherical(e[s]);Bn=D.Cartesian3.divideByScalar(D.Cartesian3.add(qn,a,Bn),2,Bn),dn=D.Cartesian3.normalize(D.Cartesian3.cross(a,qn,dn),dn),s===0?Fo=D.Cartesian3.clone(dn,Fo):D.Cartesian3.dot(D.Cartesian3.cross(Un,dn,Bo),qn)<0&&(this._isConvex=!1),this._directions[s]=a;let l=s*sr;this._normalsAndBisectorsWithMagnitudeSquared[l]=dn.x,this._normalsAndBisectorsWithMagnitudeSquared[l+1]=dn.y,this._normalsAndBisectorsWithMagnitudeSquared[l+2]=dn.z,this._normalsAndBisectorsWithMagnitudeSquared[l+3]=Bn.x,this._normalsAndBisectorsWithMagnitudeSquared[l+4]=Bn.y,this._normalsAndBisectorsWithMagnitudeSquared[l+5]=Bn.z,this._normalsAndBisectorsWithMagnitudeSquared[l+6]=D.Cartesian3.magnitudeSquared(Bn),qn=D.Cartesian3.clone(a,qn),Un=D.Cartesian3.clone(dn,Un)}D.Cartesian3.dot(D.Cartesian3.cross(Un,Fo,Bo),no)<0&&(this._isConvex=!1),this._vertices=e,this._convexHull=[],this._referenceAxis=void 0,this._referenceDistance=void 0}}},convexHull:{get:function(){return this._vertices.length!==0&&this._convexHull.length===0&&on.findConvexHull(this._directions,1,0,this._vertices.length-1,this._convexHull),this._convexHull}},referenceAxis:{get:function(){return!(0,D.defined)(this._referenceAxis)&&this.convexHull.length>0&&this.computeBoundingCone2(),this._referenceAxis}},referenceDistance:{get:function(){return!(0,D.defined)(this._referenceDistance)&&this.convexHull.length>0&&this.computeBoundingCone2(),this._referenceDistance}}});var oo=on;var Ce=Ie(we(),1);var M=Ie(we(),1);var o=Ie(we(),1);var un=`uniform vec3 u_radii;
...
`;var di=`vec4 getColor(float boundaryValue, vec3 pointMC, vec3 pointEC) {
vec4 color;
#if defined(SHOW_INTERSECTION) && !defined(ABOVE_ELLIPSOID_HORIZON)
...
`;var n=Ie(we(),1);var to=`uniform vec3 u_radii;
uniform vec3 u_inverseRadii;
uniform float u_sensorRadius;
uniform vec3 u_q;
in vec3 v_positionWC;
