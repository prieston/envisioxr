  ...
  if (
    ...
    if (length > 0) {
      ...
      for (let i = 0; i < length; ++i) {
        ...
        // Only accept the candidate vectors that truly satisfy all of the constraint equations.
        if (
          ...
          if (
            ...
            crossing.kind = 0; // This is determined duplicates are eliminated and the set is sorted.
            m.push(crossing);
          }
        }
      }

      // Eliminate any repeated solution vectors.
      length = m.length;
