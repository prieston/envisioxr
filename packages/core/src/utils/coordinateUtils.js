...
export function setReferenceLocation(latitude, longitude) {
 ...
 */
export function localToGeographic(tilesRenderer, localPos) {
 ...
 * @param altitude
 */
export function geographicToLocal(tilesRenderer, latitude, longitude, altitude) {
