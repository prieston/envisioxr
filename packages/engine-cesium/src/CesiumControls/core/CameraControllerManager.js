...
export class CameraControllerManager {
    constructor(cesiumViewer) {
        ...
        this.lastTime = 0;
        this.logger = createLogger("CameraControllerManager");
        /**
         * Animation loop
         */
    ...
    initializeControllers() {
        ...
        this.controllers.set("firstPerson", new FirstPersonWalkController(this.cesiumViewer, walkConfig));
        this.controllers.set("car", new CarDriveController(this.cesiumViewer, carConfig));
        this.controllers.set("flight", new DroneFlightController(this.cesiumViewer, flightConfig));
    ...
    switchToMode(mode) {
        ...
        if (mode === SIMULATION_MODES.ORBIT ||
     ...
     */
    enableDefaultCesiumControls(mode) {
        if (!this.cesiumViewer)
            return;
     ...
     */
    updateControllerConfig(mode, config) {
     ...
     */
    updateCesiumViewer(cesiumViewer) {
        this.cesiumViewer = cesiumViewer;
